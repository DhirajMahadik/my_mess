        ...
        <REGISTER_LOGIN className="">
            ...
            <form onSubmit={OnsubmitHandler} className="row g-3">
                ...
                <div className="col-md-6">
                    <label htmlhtmlFor="name" className="form-label">Name of your mess</label>
                ...
                <div className="col-md-6">
                    <label htmlhtmlFor="type" className="form-label">Type</label>
                ...
                <div className="col-12">
                    <label htmlhtmlFor="inputAddress" className="form-label">Address</label>
                ...
                <div className="col-12">
                    <label htmlhtmlFor="location" className="form-label">Location URL</label>
                ...
                <div className="col-md-6">
                    <label htmlhtmlFor="banner" className="form-label">Mess Banner</label>
                ...
                <div className="col-md-6">
                    <label htmlhtmlFor="password" className="form-label">Email</label>
                ...
                <div className="col-6">
                    ...
                    <label className="form-label" htmlhtmlFor="openTime">
                        Mess open at
                    </label>
                ...
                <div className="col-6">
                    ...
                    <label className="form-label" htmlhtmlFor="closeTime">
                        Mess close at
                    </label>
